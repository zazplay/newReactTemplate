...
var Switch = React63.forwardRef((props, ref) => (0, import_jsx_runtime58.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Pagination = React97.forwardRef(({
  ...
  return (0, import_jsx_runtime98.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames69.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames70.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
